...
const AVATAR_URL = '/avatar-akiyama.jpg'
  ...
  return (
    ...
    >
        ...
        <div className="relative size-20 sm:size-40 overflow-hidden rounded-full border-4 border-white/50 bg-secondary shadow-[0_20px_50px_oklch(0.72_0.18_350_/_0.2)] transition-transform duration-500 group-hover:scale-105">
          {avatarError ? (
            ...
            <img
              ...
              alt="Аватар akiyama mindset upgrading"
      ...
      <div className="flex flex-col items-center gap-2">
        <h1 className="max-w-[360px] text-2xl sm:text-4xl font-black tracking-tighter text-balance">
          akiyama mindset upgrading<span className="text-primary">_</span>
        </h1>
